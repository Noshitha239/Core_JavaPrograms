//12) Create a "Person" class with properties like name and address. Implement 
//a subclass "Student" that inherits from "Person" and includes additional 
//properties like student ID and GPA. Then, create another subclass 
//"Teacher" that inherits from "Person" and has properties like employee ID 
//and subject taught.
