//11) Design a class hierarchy for a banking system. Create a base class 
//"Account" with fields for account number, account holder name, and 
//balance. Implement two subclasses, "SavingsAccount" and 
//"CheckingAccount," that inherit from the "Account" class. Add methods for 
//deposit, withdrawal, and account-specific behaviors. (Inheritance)
